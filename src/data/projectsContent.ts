...
export const cardsData = [
	{
		id: image1.src,
		src: image1.src,
		title: 'Ремонт кабінету лікаря Високопільського центру первинної медико-санітарної допомоги',
		status: {
			wait: false,
			inprogress: true,
			finished: false,
		...
		description: {
			images: [
				...
				{
					src: 'https://www.youtube.com/embed/ui9iNMKLDpY?si=B2qbx1PSykS-apq9',
					type: 'video',
				},
				{
					src: image1_2.src,
			...
			square: 100,
			duration: '08.04.2023 - 08.05.2023',
